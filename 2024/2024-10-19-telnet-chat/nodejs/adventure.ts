...
const luke: World = {
  ...
  rooms: {
    ...
    building_room: {
      ...
      actions: [
        ...
        },
        {
          ...
          response: {
            message: 'You found a piece of wood attached to the ceiling. You are able to break it loose.',
            acquireItem: 'wood3'
          }
        },
        {
          ...
          response: {
            message: 'You are very talented. You are able to build a key somehow from the three pieces of wood with your bare hands.',
    ...
    main_hall: {
      initial: 'You are in the main hall. At the end of the hall is a locked door. There is a bomb just sitting on the floor. Part way down the hall is a small room with no door.',
      actions: [
        {
          name: 'Unlock the door',
          required: {
        ...
        },
        {
          ...
          required: {
            items: ['matches'],
            message: `How can we make the bomb explode? It seems to have a fuse...`
          },
          response: {
    ...
    camera_hall: {
      initial: `You are in another hallway. There are cameras, but you are behind them so they can't see you. There is a key hanging from a hook in the ceiling for some reason. There is a door at the end of the hall.`,
      actions: [
        {
    ...
    pre_boss_room: {
      initial: 'This room is completely empty. But there is a little room on the side. A little monster starts attacking you. He is called the nibbler. There is a door with a sign above it that says "Boss Room".',
      actions: [
        {
        ...
        },
        {
          ...
          found: ['dead nibbler'],
          response: {
            message: 'You found a sword! It is actually a shape-shifting device that can turn into a sword, knife or scissors.',
            acquireItem: 'sword'
          }
        },
        {
    ...
    boss_room: {
      ...
      actions: [
        ...
        },
        {
          ...
          required: {
            items: ['sword'],
            message: `You slice the monster with your hand. The monster is not phased.`
          },
          response: {
    ...
    last_room: {
      initial: 'You are in the last room. You find a diamond. Go through the exit. You are now a free person and a diamon richer!',
      actions: [
        {
          name: 'Exit',
          response: {
...
const violet: World = {
  ...
  rooms: {
    outside: {
      initial: `You are outside and see an interesting building. There is a door. It looks unlocked. You are curious and want to go in.`,
      actions: [
        {
          name: 'Go through the door',
          response: {
    ...
    dungeon: {
      initial: `You see yellow trampolines. And there's a yellow stick thing that goes all the way up to the ceiling. There are several security cameras.`,
      actions: [
        {
          name: 'Bounce on the trampolines',
          response: {
            find: ['past trampolines'],
            message: 'You got past the trampolines. You see an exit door across the room.',
          }
        },
        {
          ...
          response: {
            message: 'You trip on a wire. It sets off a loud alarm on top of the yellow stick thing.',
            find: ['trip wire']
          }
        },
        {
          ...
          found: ['trip wire'],
          response: {
            message: 'You make your way to the exit door. Before you get to the door, someone comes through it and says "This is a bad door to go through"',
            find: ['bad exit door']
          }
        },
        {
          ...
          found: ['bad exit door'],
          response: {
            message: `Bad guys come out looking for you, but they don't see you because you are hiding under the table. The bad guys leave. You see a big hook.`,
            find: ['hook']
          }
        },
        {
          ...
          response: {
            message: 'You jump up and grab onto the hook. Then you swing down onto a floating box. Then you jump into the pretend TNT box. You jump off of the TNT box onto the floor. You see a real exit door.',
            find: ['second door']
          }
        },
        {
