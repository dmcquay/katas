...
stderr_handler.setLevel(logging.DEBUG)  # Set log level for the handler

# Optional: configure log message format
formatter = logging.Formatter('%(asctime)s - %(name)s - %(levelname)s - %(message)s')
stderr_handler.setFormatter(formatter)

# Get the PyMongo logger and configure it
pymongo_logger = logging.getLogger('pymongo')
pymongo_logger.setLevel(logging.DEBUG)
#pymongo_logger.addHandler(stderr_handler)
